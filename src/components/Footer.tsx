                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><Link href="/contact" className="hover:text-neon-blue transition-colors">Join Us</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <Link href="mailto:iotclub@bennett.edu.in" className="text-gray-400 hover:text-neon-blue transition-colors">
